classdef Scriptlets < handle
    ...
    methods (Access = public)
        ...
        function onInsert(app,~,~)            
            ...
            loader = mrm.internal.JSONloader;
            loader.OldIDs = {};
        ...
        function onUpdate(app,varargin)
            ...
            [names,folders] = mrm.internal.getScriptletsForClass( app.getResourceRoot, wvClass );                                    
            app.ScripletDD.Items = names;            
            app.ScripletDD.ItemsData = folders;
        end
